...
def mapToLots(records):
    ...
    for record in records:
        ...
        if 'NOISE' not in compType or 'CONSTRUCTION' not in descriptor:
           continue
...
def mapResUnits(pairs):
    ...
    with open('plutolonglat','rb') as fi:
    ...
    for pair in pairs:
        ...
        yield (Long,Lat,pair[1] / float(res_units))#pair[1] = number of noise complaints
